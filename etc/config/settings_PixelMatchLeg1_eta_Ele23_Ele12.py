...
samplesDef = {
    ...
    'data'   : tnpSamples.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v_performance['data_Run2017_HLT_Commissioning'].clone(),
    'data_1'   : tnpSamples.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v_performance['data_Run2017_HLT_Nominal WP Pre Oct 5th'].clone(),
    'data_2'   : tnpSamples.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v_performance['data_Run2017_HLT_Nominal WP Post Oct 5th'].clone(),
...
samplesDef['data'  ].set_cut('(run <= 302026)')
samplesDef['data_1'  ].set_cut('(run > 302026 && run < 304366)')
samplesDef['data_2'  ].set_cut('(run >= 304366)')
...
cutBase   = 'tag_sc_et > 35 && abs(tag_sc_eta) < 2.1 && probe_sc_et > 30 && passL1T == 1 && passEtLeg1 == 1 && passClusterShapeLeg1 == 1 && passHELeg1 == 1 && passEcalIsoLeg1 == 1'
