...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.HLT_DoubleEle25_CaloIdL_MW_v2_performance['DY_powheg_M50_120_Ele35Tag'].clone(),
    'mcAlt'  : None,
    'tagSel' : None,
}
...
cutBase   = 'tag_sc_et > 35 && abs(tag_sc_eta) < 2.1 && probe_sc_et > 30 && passL1T  == 1 && passSeededEt25  == 1'
