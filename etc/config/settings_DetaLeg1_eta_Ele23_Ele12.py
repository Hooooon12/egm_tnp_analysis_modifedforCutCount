...
cutBase   = 'tag_sc_et > 35 && abs(tag_sc_eta) < 2.1 && probe_sc_et > 30 && passL1T == 1 && passEtLeg1 == 1 && passClusterShapeLeg1 == 1 && passHELeg1 == 1 && passEcalIsoLeg1 == 1 && passPixelMatchLeg1 == 1 && passOneOEMinusOneOPLeg1 == 1'
